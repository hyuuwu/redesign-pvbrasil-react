...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-margin-mobile md:px-margin-desktop h-20 bg-surface/80 backdrop-blur-md border-t border-electric-cyan/20 shadow-[0px_4px_20px_rgba(0,216,255,0.1)]">
      {/* Brand */}
      ...
      <div className="flex items-center gap-4 flex-shrink-0">
        ...
        {/* Mobile Menu Toggle */}
        <button className="md:hidden text-electric-cyan hover:bg-white/5 transition-all duration-300 p-2 rounded-full scale-95 active:scale-90 transition-transform">
